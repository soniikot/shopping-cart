...
const ListView$1 = lazy(() => import("./ListView-ZkpihEEN.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-ZkpihEEN.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-ZupWsu5G.mjs.map
