...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-Jcwh4RvB.mjs";
...
import { u as useWebhooks } from "./useWebhooks-hJU8vvFU.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-MGBOczq0.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-Dng643LK.mjs.map
