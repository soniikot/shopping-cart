...
const useWebhooks = require("./useWebhooks-yGHWSYOs.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-OZJRKU3p.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-7TjaOKuE.js.map
